                ...
                <nav class="navbar header-navbar pcoded-header">
                    <div class="navbar-wrapper">
                        ...
                        <div class="navbar-logo">
                            ...
                            <a href="menu.php">
                                <img class="img-fluid" src="asset/images/logoCafe.png"  alt="UCP" />
                            </a>
                        ...
                        <div class="navbar-container container-fluid">
                            ...
                            <div class="pcoded-main-container">
                                ...
                                <li class="">    <a href="addalumno.php">        <span class="pcoded-micon"><i class="ti-layout-cta-right"></i><b>N</b></span>        
								     <span class="pcoded-mtext" data-i18n="nav.navigate.main">Alumnos</span>        
									 <span class="pcoded-mcaret"></span>    </a>
								</li>
                                <li class="">    <a href="i-test.php">        <span class="pcoded-micon"><i class="ti-layout-cta-right"></i><b>N</b></span>        
								     <span class="pcoded-mtext" data-i18n="nav.navigate.main">Rockjs DBF</span>        
									 <span class="pcoded-mcaret"></span>    </a>
								</li>
                            </ul>
                                            </ul>
