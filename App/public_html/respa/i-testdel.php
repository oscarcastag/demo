<?php include './headers.php'; ?>
  ...
  <div class="col-sm-3">
        <div class="form-group">
           <label> </label>
            <button type="submit" id="form-submit" class="btn btn-outline-success btn-block">Eliminar</button>
        </div>
    </div>
<div class="col-sm-3">
    <div class="form-group">
...
<script type="text/javascript" src="asset/js/formtestdel.js"></script>
<script>
