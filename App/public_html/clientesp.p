...
IF Vfcve-cliente <> ? AND Vfcve-cliente <> "!" THEN DO:
   ...
   END.
   ELSE DO:
   RUN C:\proyectos\Galeno\Programas\p-ConsultaPorCliente00.p (string(int(Vfcve-cliente),"99999"), OUTPUT TABLE tt-ConsPorPoliza, OUTPUT opi-Error, OUTPUT opc-MsgError).
