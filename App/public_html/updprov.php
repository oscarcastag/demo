                ...
                <div class="p-2 mr-auto">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span><a href="addprov.php"><p class="pe-7s-back-2"></p> Regresar</a></span>
                        </div>
                    </div>
                </div>
            </div>
...
function submitForm() {
    ...
    $.ajax({
		type: "POST",
		url: host + "/Test/moditest.php",
		data: "action=moditest&jwt=" + jwt + "&" + dataString,
