...
<html lang="es">
    <head>
        <title>Customer Care Associates®</title>
        <meta charset="utf-8">
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta name="apple-mobile-Web-app-title" content="Customer Care Associates®">
        <meta name="author" content="Customer Care Associates®|Focus On Services">
    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav" style="margin-top:40px">
            ...
            <div id="OpMen1">
                <a href="i-acto.php">Oracle 11 - Actos</a>
                <a href="i-datos.php">SQL Server 8 - Datos</a>
                <a href="i-areas.php">Progress 91D - Areas</a>
            </div>
            <a href="index.html" onclick="louout()">Salir</a>
        </div>
        <div id="main">
            <div class=" navbar bg-light fixed-top" style="color: #005689 !important; padding-bottom: 0; padding-top: 0;">
                <div class="float-left mn-left">
                    ...
                    <a class="navbar-brand" href="#">&nbsp&nbsp&nbsp<img src="asset/images/sniglet.png" width="10%" alt="RockJS Framework" style="vertical-align: baseline !important;"></a>
                </div>

                <div class="float-right mn-rigth">
                    

                    <img src="asset/images/progress.png" title="" class="rounded-circle" style="width:100px; vertical-align: baseline !important;">
                </div>
            </div>
