...
/**
 * script para ver la version del producto php 
 */
//1 incluir el archivo /rockjs/openrockjs.php
include_once '../rockjs/openrockjs.php';

//2 Crear una instancia de la clase openrockjs

$objRockJS;              //creamos una variable objRockJS

$prog_info = 'version'; //Cramos una variable que servira para 
                        //definir el comando a ejecutar

$objRockJS = new RockJS(); // instanciamos la variable a la clase openrockjs

echo $objRockJS->_openrockjs($prog_info);  //accedemos a la funcion _openrockjs()
                                           //y le pasamos el parametro $prog_info
                        echo '<H3> <a href="index.php">Regresar Instalación Rockjs Framework </a></H3>';
