            ...
            <div>
                <div class="container">
                    ...
                    if (empty($_GET["p"])) {
                        ...
                        echo "<H3>Felicidades...Por favor contactar a Focus on Services para su registro  </H3>";
                        echo '<H3> <a href="../docs/">Documentacion Rockjs Framework v01</a></H3>';
                        echo '<H3> <a href="version.php">Version y Licencia</a></H3>';
                        echo '<H3> <a href="validatoken.php">Validación de token JWT</a></H3>';
                        echo "</Table>";
                        echo "</tr>";
                        //setProgram($prog);
                    } else {
